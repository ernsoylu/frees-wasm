...
cargo test --release --workspace       # all tests incl. the parity replay
                                       # (--release: the replay solves 1279 documents,
                                       #  270 s of the run measured at Wave P1 on a
                                       #  shared machine — 2026-08-24)
